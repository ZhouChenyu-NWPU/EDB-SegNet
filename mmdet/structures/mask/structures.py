...
def polygon_to_bitmap(polygons, height, width):
    ...
    """
    # rles = maskUtils.frPyObjects(polygons, height, width)  # ly修改2025-03-12 源码写法
    rles = maskUtils.frPoly(polygons, height, width)  # ly修改2025-03-12 修改替换 相应地修改 anaconda3/envs/mmlab/lib/python3.9/site-packages/pycocotools/mask.py
