...
from .model_utils import Muti_AFF, MFACB, ESPMFACB
...
class DDRNet(BaseModule):
    ...
    def __init__(self,
        ...
        self.s_gltb1 = Block(dim=64, num_heads=8, window_size=8)
        self.s_gltb2 = Block(dim=64, num_heads=8, window_size=8)
        # self.s_gltb3 = Block(dim=128, num_heads=8, window_size=8)
        ...
        self.layer3 = nn.Sequential(
                ...
                # ESPMFACB(planes * 2, planes * 2, planes * 2, stride_1=1, Ker=[4, 4, 4], recept_limit=[11, 9, 7]),
                # ESPMFACB(planes * 2, planes * 2, planes * 2, stride_1=1, Ker=[4, 4, 4], recept_limit=[9, 7, 5]),
                # EESP(self.eesp_channels[2], self.eesp_channels[3], stride=2, k=self.K[0], r_lim=self.recept_limit[0]),
                # EESP(self.eesp_channels[3], self.eesp_channels[3], stride=1, k=self.K[0], r_lim=self.recept_limit[0]),
                # EESP(self.eesp_channels[3], self.eesp_channels[3], stride=1, k=self.K[0], r_lim=self.recept_limit[0]),
        ...
        self.layer5 = EESP(self.eesp_channels[4], self.eesp_channels[5], stride=2, k=self.K[2], r_lim=self.recept_limit[2])
        self.layer5_ = EESP(self.eesp_channels[2], self.eesp_channels[3], stride=1, k=self.K[2], r_lim=self.recept_limit[2])
