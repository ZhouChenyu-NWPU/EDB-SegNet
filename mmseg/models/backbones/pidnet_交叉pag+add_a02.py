...
class PIDNet(BaseModule):
    ...
    def forward(self, x: Tensor) -> Union[Tensor, Tuple[Tensor]]:
        ...
        # 交叉1
        x_pi_1 = self.basic_pi_1(x_p)
        x_di_1 = self.basic_di_1(x_d)
        # x_i = self.dfm(x_pi_1, x_i, x_di_1)
        x_i = self.pag_pi_1(x_pi_1, x_i)
        x_i = x_i + x_di_1
        ...
        # 交叉2
        x_pi_2 = self.basic_pi_2(x_p)
        x_di_2 = self.basic_di_2(x_d)
        # x_i = self.dfm1(x_pi_2, x_i, x_di_2)
        x_i = self.pag_pi_2(x_pi_2, x_i)
        x_i = x_i + x_di_2
