...
class EESP(nn.Module):
    ...
    def __init__(self, nIn, nOut, stride=1, k=4, r_lim=7, down_method='esp', Spatial=True, SPASPP_Flag=False, EESPV2=True):  #down_method --> ['avg' or 'esp']
        '''
